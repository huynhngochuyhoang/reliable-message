...
@SpringBootTest(
        classes = RabbitRpcWebFluxBrokerBackedVirtualThreadSmokeTest.SampleApplication.class,
        webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT,
        properties = {
                "message.reliability.rpc.rabbit.webflux.enabled=true",
                "message.reliability.rpc.rabbit.webflux.exchange=s4.rpc.virtual.exchange",
                "message.reliability.rpc.rabbit.webflux.default-timeout=300ms",
                "message.reliability.rpc.rabbit.webflux.executor-mode=virtual-thread",
                "message.reliability.rpc.rabbit.webflux.max-concurrency=1",
                "message.reliability.rpc.rabbit.webflux.max-attempts=1",
...
class RabbitRpcWebFluxBrokerBackedVirtualThreadSmokeTest {
    ...
    static class SampleApplication {
        ...
        DirectExchange rpcExchange() {
            return new DirectExchange("s4.rpc.virtual.exchange", true, false);
        }

        @Bean
        Queue rpcQueue() {
            return QueueBuilder.durable("s4.rpc.virtual.orders").build();
        }
